...
export class MissionsScreen {
    ...
    _renderQuests() {
        const quests = this.app.localService.getDailyQuests();
        let html = '';
        ...
        this.element.querySelectorAll('.claim-quest-btn').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                if (this.app.localService.claimDailyQuest(id)) {
                    this.updateUI();
                }
            });
        });
    ...
    _renderAchievements() {
        const stats = this.app.localService.getStats();
        const claimedAch = this.app.localService.getAchievements();
        ...
        this.element.querySelectorAll('.claim-ach-btn').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                if (this.app.localService.claimAchievement(id, reward)) {
                    this.updateUI();
                }
            });
        });
