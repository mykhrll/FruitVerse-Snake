...
export class LoginScreen {
    ...
    onEnter() {
        ...
        const savedName = this.app.localService.load('playerName', '');
    ...
    async handleLogin() {
        ...
        try {
            ...
            this.app.localService.setPlayerName(name);
            await this.app.cloudService.initCloudProfile(name);
            await this.app.cloudService.fetchGlobalDailyQuests();
